...
return {
  ["en"] = {
    ...
    ["jail_out"] = function(_translate, _target, player) return _concat({ "<V>", player, " <J>did some parkour to escape jail!" }) end,
  ...
  ["tr"] = {
    ...
    ["jail_out"] = function(_translate, _target, player) return _concat({ "<V>", player, " <J>hapisten çıktı" }) end,
