...
return {
  ...
  ["ar"] = {
    ...
    ["jail_out_card"] = function(_translate, _target, player) return _concat({ "<V>", player, " <J>استخدمت بطاقة \"الخروج من السجن مجانًا\"." }) end,
    ...
    ["mortgage"] = "<p align=\"center\"><b><R><a href=\"event:mortgage\">Mortgage",
    ["unmortgage"] = "<p align=\"center\"><b><VP><a href=\"event:unmortgage\">Unmortgage",
    ["card_1"] = "البداية - اجمع 200 كلما مررت",
    ...
    ["community_6"] = "استحقاق التأمين على الحياة احصل على 100$",
    ["community_7"] = "لقد فزت بالجائزة الثانية في مسابقة جمال احصل على 10$",
    ...
    ["community_13"] = "اخرج من السجن مجانًا قد يتم الاحتفاظ بهذه البطاقة لحين الحاجة إليها",
    ["chance_1"] = "تقدم الى البداية واحصل على 200$",
    ["chance_2"] = "تقدم إلى Bootcamp Avenue",
    ["chance_3"] = "عد إلى الوراء ثلاث مسافات",
    ["chance_4"] = "تقدم إلى Transformice Alley إذا نجحت في اجتياز البداية أحصل على 200$",
    ["chance_5"] = "قم برحلة إلى المحطة التجارية إذا نجحت في اجتياز البداية  أحصل على 200$",
    ["chance_6"] = "تقدم إلى Towerdefence Street إذا مررت البداية أحصل على 200$",
    ["chance_7"] = "أدفع مصروفات المدرسة 150$",
    ["chance_8"] = "غرامة السرعة 15$",
    ["chance_9"] = "قم بإجراء إصلاحات عامة على جميع منازلك مقابل كل منزل ادفع 25$ مقابل كل فندق ادفع 100$",
    ["chance_10"] = " يجب عليك اصلاح الشوارع مقابل كل منزل ادفع 40$ مقابل كل فندق ادفع 115$",
