...
return {
  ["en"] = {
    ...
    ["purchase"] = function(_translate, _target, player, propertycolor, purchaseproperty) return _concat({ "<V>", player, " <J>purchased <font color=\"#", propertycolor, "\">", purchaseproperty, "" }) end,
    ["auction"] = function(_translate, _target, player, propertycolor, auctionproperty) return _concat({ "<V>", player, " <J>purchased <font color=\"#", propertycolor, "\">", auctionproperty, " <J>in the auction." }) end,
    ["pay_rent"] = function(_translate, _target, player, money, playerowner) return _concat({ "<V>", player, " <J>payed <VP>$", money, " <J>in rent to <V>", playerowner, "." }) end,
    ["jail_in"] = function(_translate, _target, player) return _concat({ "<V>", player, " <R>was sent to jail!" }) end,
    ["jail_out_money"] = function(_translate, _target, player) return _concat({ "<V>", player, " <J>paid the $50 fine to get out of jail." }) end,
    ...
    ["mortgage_property"] = function(_translate, _target, player, playerowner) return _concat({ "<V>", player, " <J>landed on <V>", playerowner, "<J>. Property is mortgaged, no rent was collected." }) end,
    ["warn_need_fullset"] = "<J>Before you can buy a house, you must own all the properties of a color-group.",
    ["log_card"] = function(_translate, _target, player, type, cardtext) return _concat({ "<V>", player, " <ROSE>drew a <J>", type, " <ROSE>card: <CH>", _translate(cardtext, _target), "" }) end,
    ["community"] = "community",
    ["chance"] = "chance",
    ...
    ["ui_house_title"] = "<font size=\"20\" color=\"#ffffff\"><p align=\"center\"><a href=\"event:close_house\">Manage Houses",
  ...
  ["tr"] = {
    ...
    ["purchase"] = function(_translate, _target, player, propertycolor, purchaseproperty) return _concat({ "<V>", player, " <font color=\"#", propertycolor, "\">", purchaseproperty, " <J>arazisini satın aldı." }) end,
    ["auction"] = function(_translate, _target, player, propertycolor, auctionproperty) return _concat({ "<V>", player, " <J>ihaleyle <font color=\"#", propertycolor, "\">", auctionproperty, " <J>arazisini satın aldı." }) end,
    ...
    ["jail_out_money"] = function(_translate, _target, player) return _concat({ "<V>", player, " <J>hapisten çıktı" }) end,
    ...
    ["log_card"] = function(_translate, _target, player, type, cardtext) return _concat({ "<V>", player, " <ROSE>bir <J>", type, " <ROSE>kartı çekti: <N>", _translate(cardtext, _target), "" }) end,
    ["community"] = "topluluk",
    ["chance"] = "şans",
    ...
    ["ui_house_title"] = "<font size=\"20\" color=\"#ffffff\"><p align=\"center\"><a href=\"event:close_house\">Evleri Yönet",
